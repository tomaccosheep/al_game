...
class Spell:
    # This creates a spell. The name determines
...
class Furniture:
    def __init__(self, name):
        if name == 'barrel':
            self.gunpowder = Item('gunpowder', 'It looks explosive', 'barrel')
        self.param = {'drawer': [10, None], 'barrel': [10, self.gunpowder]}
        has = self.param[name][1]
